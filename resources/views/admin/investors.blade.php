<x-app-layout>
    <section class="section">
        ...
        <div class="col-12 list-group list-group-light">
            @foreach ($investors as $investor)
                ...
                <div class="modal fade" id="deleteModal{{$investor->id}}" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form method="POST" action="{{route('admin-delete-investor')}}">
                            @csrf
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="investor_id" value="{{$investor->id}}" required>
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            <form method="POST" action="{{route('admin-add-investor')}}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Interests</label>
                        <div class="col-sm-10">
